# Armor-Duplicate-Detector
Python program for highlighting duplicate armor pieces that are safe to delete in DIM

## Instructions
1. In DIM navigate to Organizer
2. Select any one of the class filters
